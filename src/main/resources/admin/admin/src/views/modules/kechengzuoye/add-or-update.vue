		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.xiangguanfujian" label="相关附件" prop="xiangguanfujian">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","color":"rgba(255, 255, 255, 1)","outline":"none","borderRadius":"4px","background":"#6aab9c","width":"auto","lineHeight":"40px","fontSize":"14px","fontWeight":"400","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.xiangguanfujian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="!ruleForm.xiangguanfujian" label="相关附件" prop="xiangguanfujian">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zuoyeneirong = this.ruleForm.zuoyeneirong.replace(reg,'../../../springbootsagm21hd/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
