  ...
  <div class="main-content" :style='{"padding":"20px 30px","background":"#f9fbfd","flexDirection":"column","display":"flex"}'>
	...
	<div :style='{"width":"100%","padding":"0"}'>
        ...
        >
          ...
          >
            <template slot-scope="scope">
			  <el-button class="view" :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 5px 10px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#6aab9c","width":"auto","fontSize":"14px","fontWeight":"600","height":"32px"}' type="success" @click="addOrUpdateHandler(scope.row)">
			  	<span class="icon iconfont icon-chakan2" :style='{"margin":"0 0px","fontSize":"14px","color":"#fff","height":"40px"}'></span>
			  	查看
			  </el-button>
			  <el-button class="edit" :style='{"border":"0","cursor":"pointer","padding":"0 5px","margin":"0 5px 10px 0","outline":"none","color":"#fff","borderRadius":"4px","background":"#f7b36b","width":"auto","fontSize":"14px","fontWeight":"600","height":"32px"}' v-if="isAuth('examrecord','批卷')&&scope.row.ismark>0" type="primary" @click="gradeClick(scope.row)">
