	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="作业评分" prop="zuoyepingfen">
					<el-input v-model="ruleForm.zuoyepingfen"  placeholder="作业评分" clearable  :readonly="ro.zuoyepingfen"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="作业评分" prop="zuoyepingfen">
					<el-input v-model="ruleForm.zuoyepingfen" placeholder="作业评分" readonly></el-input>
				</el-form-item>
