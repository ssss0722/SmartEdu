	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="课程类别" prop="kechengleibie">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="课程类别" prop="kechengleibie">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.jiaoxueshipin" label="教学视频" prop="jiaoxueshipin">
					<file-upload
						tip="点击上传教学视频"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.jiaoxueshipin" label="教学视频" prop="jiaoxueshipin">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"4px","background":"#6aab9c","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.jiaoxueshipin)">预览</el-button>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="!ruleForm.jiaoxueshipin" label="教学视频" prop="jiaoxueshipin">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="基本介绍" prop="jibenjieshao">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.jibenjieshao" label="基本介绍" prop="jibenjieshao">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jibenjieshao = this.ruleForm.jibenjieshao.replace(reg,'../../../springbootsagm21hd/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
