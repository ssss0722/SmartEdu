...
CREATE TABLE `course_homework`  (
  ...
  `t_name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '教师姓名',
...
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '教学资料' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of course_material
-- ----------------------------
INSERT INTO `course_material` VALUES (31, '2024-03-05 11:41:50', '标题1', '课程名称1', 'upload/jiaoxueziliao_tupian1.jpg,upload/jiaoxueziliao_tupian2.jpg,upload/jiaoxueziliao_tupian3.jpg', '', '教师工号1', '教师姓名1', '2024-03-05 11:41:50', '内容1', '2025-06-29 17:06:15', 4, 0, 1);
...
INSERT INTO `course_material` VALUES (36, '2024-03-05 11:41:50', '标题6', '课程名称7', 'upload/jiaoxueziliao_tupian6.jpg,upload/jiaoxueziliao_tupian7.jpg,upload/jiaoxueziliao_tupian8.jpg', '', '教师工号6', '教师姓名6', '2024-03-05 11:41:50', '内容6', '2024-03-05 11:41:50', 6, 0, 6);
...
CREATE TABLE `discuss_course_homework`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '课程作业评论表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `discuss_course_video`  (
  ...
  `reply` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '回复内容',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '教学视频评论表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `exam_paper`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addtime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `name` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '在线考试名称',
  `time` int NOT NULL COMMENT '测试时长(分钟)',
  `status` int NOT NULL DEFAULT 0 COMMENT '在线考试状态',
  `t_username` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '教师工号',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `exam_question`  (
  ...
  `papername` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '在线考试名称',
...
-- Records of store_up
-- ----------------------------
INSERT INTO `store_up` VALUES (1, '2024-03-05 11:57:04', 1709611010643, 39, 'course_material', '初级编程', 'upload/1709610789808.jpg', '1', '编程', NULL);
...
INSERT INTO `store_up` VALUES (4, '2024-03-05 11:58:26', 1709611010643, 49, 'course_material', '初级编程', 'upload/1709610825018.jpg', '1', '编程', NULL);
INSERT INTO `store_up` VALUES (5, '2025-06-29 19:32:31', 1709611010643, 59, 'course_material', '标题7', NULL, '1', '课程类别7', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1751161709293 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '学生' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user_student` VALUES (1751161709292, '2025-06-29 09:48:29', '111', NULL, '123', '男', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1751122764438 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '教师' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `user_teacher` VALUES (1709610637034, '2024-03-05 11:50:37', '111', '杨洋', '123', '女', 'upload/1709610626972.png', '13612514514', '编程');
INSERT INTO `user_teacher` VALUES (1751122764437, '2025-06-28 22:59:24', 'abc', '张三', '123', '男', NULL, NULL, NULL);
